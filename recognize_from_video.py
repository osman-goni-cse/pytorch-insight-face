...
def tracking(detector, args):
    ...
    # video_path = '/home/osman/Downloads/anik_vai.mp4'
    # video_path = '/home/osman/Videos/abc.mp4'
    cap = cv2.VideoCapture("rtsp://admin:dsi185185@10.0.2.39:554/cam/realmonitor?channel=1&subtype=0")
    # cap = cv2.VideoCapture(video_path)conda activate real-time
                ...
                if mapping_score > 0.3:
                    ...
                    if name is not None:
                        if score < 0.5:
                            ...
                            img_path = os.path.join('/home/osman/PycharmProjects/ComputerVision/face-recognition/datasets/RealTimeRecognized', f"{name}_{str(score)}_{uuid_string}.png")
                            cv2.imwrite(img_path, face_alignment)
